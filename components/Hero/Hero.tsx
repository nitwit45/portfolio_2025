...
export default function Hero() {
    const handleClick = () => {
        const email = "nithila7777@gmail.com";
            ...
            <section className="flex flex-col lg:flex-row items-center flex-none flex-nowrap gap-[20px] h-min justify-start overflow-visible p-0 relative w-full ">
                ...
                <div className="flex flex-col items-start gap-2 p-0 relative w-full h-auto">
                    ...
                    <motion.p
                        ...
                        AI engineer and data scientist from Colombo, Sri Lanka, with a passion for developing intelligent systems and a proven track record in machine learning, computer vision, and software engineering.
                    </motion.p>
