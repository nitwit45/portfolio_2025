    ...
    return (
        <div className='flex items-start flex-none flex-col flex-nowrap gap-[30px] h-min justify-start overflow-visible relative w-full '>
            <div className="flex-none h-auto relative w-full">
                <SectionHeading icon={briefcaseIconley} title='My experience' description='Bridging AI, data science, and software engineering to craft intelligent solutions, leveraging adaptability and technical expertise to drive innovation across diverse domains.' />
            </div>
                        ...
                        myExperience?.map((exp, index) => (
                            <motion.li
                                ...
                                <div className="w-full flex justify-between flex-none items-center h-min flex-nowrap overflow-visible p-0 relative">
                                    ...
                                    <div className="flex flex-nowrap gap-[10px] h-min overflow-visible p-0 min-w-[60px] sm:min-w-[100px]">
                                        <h3 className='text-light-gray-4 font-bold text-lg sm:text-[22px] leading-[1.2em] text-right sm:text-left'>
                                            {exp.year}
                                        </h3>
                                    </div>
